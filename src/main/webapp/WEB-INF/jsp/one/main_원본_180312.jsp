...
<!--                 <a class="navbar-brand page-scroll" href="#page-top"><img src="/img/img_logo.png" class="img-responsive" alt="GoPAY 로고"></a> -->
            ...
            <div class="collapse" id="menu-navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="page-scroll" href="#gopay">METAPAY</a></li>
				...
				<li data-transition="fade" data-slotamount="7" >
					...
					<div class="caption lfb ltb rs-parallaxlevel-3"
						...
						<h5>
                            ...
                            Start up 기업부터 global 법인 까지,<br/>METAPAY는 HR 부서의 Tool이 될 수 있는<br/> 
...
<section id="gopay" class="whatwedo">
	<div class="container">
		<div class="section-title-wrap">
			<h2 class="section-title wow fadeInDown" data-wow-delay="0.2s"><span class="txt_green">META</span>PAY</h2>
			<span class="separator wow fadeInDown" data-wow-delay="0.4s"></span>
			<p class="txt_add01">Business의 성장 + 기술의 확장성</p>
			<p class="txt_add02">METAPAY 최적의 조합 </p>
			...
			<ul id="process-slider">
				<li>
					<div class="process-wrap">
						<p class="txt_add01 white">당신의 비즈니스는 <span class="txt_green bold">성장할 것입니다.</span></p>
				...
				<li>
					<div class="process-wrap">
                        <p class="txt_add01 white"><span class="txt_green bold">HR system</span> 무엇이 필요하십니까?</p>
						<div class="process-desc word-break">
				...
				<li>
					<div class="process-wrap">
						<p class="txt_add01 white"><span class="txt_green bold">개인정보보호</span> 및 보안 정책</p>
						<div class="process-desc word-break">
			...
			<div class="col-sm-4">
				<div class="contact-wrap">
					<div class="contact-info">
						<p>Phone</p>
						<h2><a>02-2040-5300</a></h2>
					</div>
					<div class="contact-info">
						<p>Email</p>
						<h2><a>jh.oh@metanet.co.kr</a></h2>
					</div>
					<div class="contact-info">
						<p>Address</p>
						<h3 class="address">서울시 종로구 청계천로 85<br> (관철동 삼일빌딩 5층)</h3>
					</div>
					<div class="contact-info">
						<p>Open</p>
...
<footer>
	<div class="container">
			<div class="col-sm-2">
				<img class="img-responsive center-block" style="width:11%; " src="/img/img_logo_metanet.png" alt="metanet SNC">
			</div>
			<div class="col-sm-10">
				<p class="company-info">
				   서울시 종로구 청계천로 85 (관철동 삼일빌딩 5층) / 업무 및 영업문의 02 2040 5366 /<a href="javascript:popup();">개인정보처리방침</a><br/>
                    사업자등록번호 220 88 11297 대표자 정일<br/>
                    CopyrightⓒMetanetSNC Co.,Ltd. All rights reserved.<br/>
				</p>
			</div>
	</div>
</footer>	
